...
module.exports = function (app) {
      ...
      // Custom
      app.get('/scrape-schedule', isUserAllowed, function (req, res) {
            res.locals = { title: 'Scrape Schedule' };
            res.render('InternalLinkMonitor/scrape-schedule' );
      });
      app.get('/application-log', isUserAllowed, function (req, res) {
            res.locals = { title: 'Application Log' };
            res.render('InternalLinkMonitor/application-log' );
      });
      app.get('/scrape-log', isUserAllowed, function (req, res) {
            res.locals = { title: 'Scrape Log' };
            res.render('InternalLinkMonitor/scrape-log' );
      });
      app.use('/api', api);
